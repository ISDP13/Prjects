...
exports.runDb = exports.feedbackCollection = exports.userCollection = exports.postsCollection = exports.blogCollection = exports.db = exports.client = void 0;
var mongodb_1 = require("mongodb");
var dotenv_1 = require("dotenv");
dotenv_1.default.config();
var mongoURI = process.env.MONGO_URL || 'mongodb://0.0.0.0:27017';
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, exports.client.db("BlogsDb").command({ ping: 1 })];
                case 2:
                    _b.sent();
