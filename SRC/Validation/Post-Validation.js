...
var BlogIdValidation = (0, express_validator_1.body)('blogId')
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, query_Blog_Repo_1.blogsQueryRepository.FindBlogsById(value)];
            case 1:
                blog = _a.sent();
                if (!blog) {
...
var PostsValidation = function () { return [TitleValidation, ShortDescriptionValidation, ContentValidation, BlogIdValidation, inputValidationBlgsANDPsts_1.inputModelValidation]; };
exports.PostsValidation = PostsValidation;
var createPostFromBlogValidation = function () { return [TitleValidation, ShortDescriptionValidation, ContentValidation, inputValidationBlgsANDPsts_1.inputModelValidation]; };
